            ...
            <div className="container mx-auto px-4">
                <div className="max-w-6xl mx-auto">
                    ...
                    {(paragraph1 || paragraph2) && (
                        <Card className="p-6 md:p-8 mb-8 bg-gradient-to-br from-green-50 to-blue-50 border-none shadow-md">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {/* Fasilitas Card */}
                        <Card className="p-6 md:p-8 hover:shadow-xl transition-shadow duration-300 border-2 border-green-100">
                            ...
                            <ul className="space-y-3">
                                {[1, 2, 3, 4].map((num) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <span className="text-green-600 font-bold mt-1 group-hover:scale-110 transition-transform">✓</span>
                        ...
                        <Card className="p-6 md:p-8 hover:shadow-xl transition-shadow duration-300 border-2 border-blue-100">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                {[1, 2, 3, 4].map((num) => {
                                    ...
                                    return (
                                        <li
                                            ...
                                            className="flex items-start gap-3 text-gray-700 group"
                                        >
                                            <span className="text-blue-600 font-bold mt-1 group-hover:scale-110 transition-transform">✓</span>
                                            <span className="flex-1 text-base leading-relaxed">{item}</span>
                                        </li>
                                    )
                                })}
